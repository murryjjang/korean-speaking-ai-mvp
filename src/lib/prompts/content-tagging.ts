...
export function buildContentTaggingSystemPrompt(): string {
  ...
  return [
    ...
    '   - **콘텐츠 핵심 행동·맥락을 구체적으로** 반영. "의사소통할 수 있다"처럼 막연한 표현 금지.',
    '   - 유형별 목표(반드시 type에 맞게):',
    '     · **낭독(type=qt-reading)**: 콘텐츠 주제 + "정확한 발음으로 …소리 내어 읽을 수 있다"를 결합한 하이브리드.',
    '       (예: "병원·약국 안내문을 정확한 발음으로 소리 내어 읽을 수 있다") — 주제만/읽기만 단독 금지.',
    '     · **발표·자료설명(type=qt-material-desc)**: 콘텐츠 + 설명·발표 능력 (예: "등록 인원 변화를 설명할 수 있다").',
    '       낭독 가이드(소리 내어 읽기·연음)를 적용하지 말 것.',
    '     · **그 외 유형**: 콘텐츠 중심 과제 행위를 기술.',
    ...
    '     길거나 어려운 글도 예외 없음 — 연음·경음화 등이 일어나는 표현을 반드시 찾을 것.',

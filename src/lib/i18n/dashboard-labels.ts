...
export const PRACTICE_LABELS = {
  ...
  // v1.1 단계 19.18: 자유 대화 정체성 안내 + 종합 화면 발음 점수 요약 라벨.
  // 자유 대화는 표현·흐름 연습이며 정확 발음 평가는 낭독·발표에서 진행됨을 명시.
  // ar/vi/en/ko는 정식 번역, th/ms/km는 기존 합의된 임시 번역 (단계 23에서 검수).
  free_conv_purposeNotice: {
    ko: "이 활동은 표현과 대화 흐름을 연습하는 단계입니다. 정확한 발음 평가는 \"읽기연습\"과 \"발표연습\"에서 진행됩니다.",
    en: "This activity is for practicing expression and conversation flow. Accurate pronunciation assessment is done in \"Reading Practice\" and \"Presentation Practice\".",
    vi: "Hoạt động này dùng để luyện diễn đạt và mạch hội thoại. Đánh giá phát âm chính xác được thực hiện trong \"Luyện đọc\" và \"Luyện thuyết trình\".",
    ar: "هذا النشاط مخصص لممارسة التعبير وتدفق المحادثة. يتم تقييم النطق الدقيق في \"تمرين القراءة\" و\"تمرين العرض\".",
    th: "กิจกรรมนี้ใช้สำหรับฝึกการแสดงออกและการไหลของบทสนทนา การประเมินการออกเสียงที่แม่นยำจะทำใน \"แบบฝึกการอ่าน\" และ \"แบบฝึกการนำเสนอ\"",
    ms: "Aktiviti ini untuk melatih ekspresi dan aliran perbualan. Penilaian sebutan yang tepat dilakukan dalam \"Latihan Bacaan\" dan \"Latihan Pembentangan\".",
    km: "សកម្មភាពនេះគឺសម្រាប់អនុវត្តការបង្ហាញនិងលំហូរនៃការសន្ទនា។ ការវាយតម្លៃការបញ្ចេញសំឡេងត្រឹមត្រូវត្រូវបានធ្វើនៅក្នុង \"ការអនុវត្តការអាន\" និង \"ការអនុវត្តការបង្ហាញ\"។",
  } satisfies LabelMap,

  // ── 종합 화면 발음 점수 요약 ──
  free_conv_summaryPronTitle: {
    ko: "발음 점수 요약",
    en: "Pronunciation Score Summary",
    vi: "Tóm tắt điểm phát âm",
    ar: "ملخص درجة النطق",
    th: "สรุปคะแนนการออกเสียง",
    ms: "Ringkasan Skor Sebutan",
    km: "សង្ខេបពិន្ទុការបញ្ចេញសំឡេង",
  } satisfies LabelMap,
  free_conv_summaryPronAvg: {
    ko: "평균",
    en: "Average",
    vi: "Trung bình",
    ar: "المتوسط",
  ...
  free_conv_summaryPronCount: {
    ko: "평가된 발화",
    en: "Evaluated utterances",
    vi: "Số phát âm được đánh giá",
    ar: "العبارات المُقيَّمة",
    th: "การออกเสียงที่ประเมินแล้ว",
    ms: "Ujaran dinilai",
    km: "ការនិយាយដែលបានវាយតម្លៃ",
  } satisfies LabelMap,
  free_conv_summaryPronDistribution: {
    ko: "구간별 분포",
    en: "Distribution by range",
    vi: "Phân bố theo khoảng",
    ar: "التوزيع حسب النطاق",
    th: "การกระจายตามช่วง",
    ms: "Taburan mengikut julat",
    km: "ការចែកចាយតាមជួរ",
  } satisfies LabelMap,
  free_conv_summaryPronBucketLow: {
    ko: "50점 미만",
    en: "Below 50",
    vi: "Dưới 50",
    ar: "أقل من 50",
  ...
  free_conv_summaryPronBucketMid: {
    ko: "50–69",
    en: "50–69",
    vi: "50–69",
    ar: "50–69",
  ...
  free_conv_summaryPronBucketHigh: {
    ko: "70–84",
    en: "70–84",
    vi: "70–84",
    ar: "70–84",
  ...
  free_conv_summaryPronBucketTop: {
    ko: "85점 이상",
    en: "85 and above",
    vi: "85 trở lên",
    ar: "85 وما فوق",
  ...
  free_conv_summaryPronNotice: {
    ko: "표현 연습용 점수입니다. 정식 발음 평가는 읽기·발표 연습에서 확인하세요.",
    en: "These scores are for expression practice only. Refer to Reading and Presentation Practice for formal pronunciation assessment.",
    vi: "Đây là điểm dành cho luyện diễn đạt. Hãy xem Luyện đọc và Luyện thuyết trình để có đánh giá phát âm chính thức.",
    ar: "هذه الدرجات لممارسة التعبير فقط. راجع تمرين القراءة وتمرين العرض للتقييم الرسمي للنطق.",
    th: "คะแนนเหล่านี้สำหรับการฝึกการแสดงออกเท่านั้น ดูแบบฝึกการอ่านและการนำเสนอสำหรับการประเมินการออกเสียงอย่างเป็นทางการ",
    ms: "Skor ini hanya untuk latihan ekspresi. Rujuk Latihan Bacaan dan Pembentangan untuk penilaian sebutan rasmi.",
    km: "ពិន្ទុទាំងនេះគឺសម្រាប់តែការអនុវត្តការបង្ហាញប៉ុណ្ណោះ។ សូមមើលការអនុវត្តការអាននិងការបង្ហាញសម្រាប់ការវាយតម្លៃការបញ្ចេញសំឡេងផ្លូវការ។",
  } satisfies LabelMap,
  free_conv_summaryPronEmpty: {
    ko: "이번 대화에서는 발음 평가가 활성화되지 않았거나 평가된 발화가 없습니다.",
    en: "Pronunciation assessment was not enabled in this session, or no utterances were evaluated.",
    vi: "Đánh giá phát âm chưa được bật trong phiên này hoặc chưa có phát âm nào được đánh giá.",
    ar: "لم يتم تفعيل تقييم النطق في هذه الجلسة، أو لم يتم تقييم أي عبارة.",
    th: "ไม่ได้เปิดใช้งานการประเมินการออกเสียงในเซสชันนี้ หรือไม่มีการออกเสียงใดถูกประเมิน",
    ms: "Penilaian sebutan tidak diaktifkan dalam sesi ini, atau tiada ujaran dinilai.",
    km: "ការវាយតម្លៃការបញ្ចេញសំឡេងមិនត្រូវបានបើកនៅក្នុងវគ្គនេះទេ ឬគ្មានការនិយាយត្រូវបានវាយតម្លៃ។",
  } satisfies LabelMap,
} as const
